...
| `validate_incoming.js`  | `node scripts/validate_incoming.js <dossier>` | Valide la convention d'ingestion (`incoming/<type>/<nom_snake_case>.<ext>`) avant d'intégrer un asset en base |
