...
├── lang/                ← en.json (source de vérité, 985 clés), fr/es/de/it.json
...
├── tests/               ← 31 suites Vitest (586 tests) + tests/php/ (PHPUnit)
...
- **586 tests** (Vitest + jsdom), 31 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
