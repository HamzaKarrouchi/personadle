...
├── lang/                ← en.json (source de vérité, 1006 clés), fr/es/de/it/pt.json
...
├── tests/               ← 36 suites Vitest (682 tests) + tests/php/ (PHPUnit)
...
- **682 tests** (Vitest + jsdom), 36 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
