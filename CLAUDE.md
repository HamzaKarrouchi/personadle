...
├── lang/                ← en.json (source de vérité, 1115 clés), fr/es/de/it/pt.json
...
├── tests/               ← 55 suites Vitest (979 tests) + tests/php/ (PHPUnit)
...
- **979 tests** (Vitest + jsdom), 55 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
