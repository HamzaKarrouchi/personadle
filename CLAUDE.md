...
├── lang/                ← en.json (source de vérité, 969 clés), fr/es/de/it.json
...
├── tests/               ← 26 suites Vitest (482 tests) + tests/php/ (PHPUnit)
...
- **482 tests** (Vitest + jsdom), 26 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
