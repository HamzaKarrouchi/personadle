...
├── lang/                ← en.json (source de vérité, 1004 clés), fr/es/de/it/pt.json
...
├── tests/               ← 35 suites Vitest (674 tests) + tests/php/ (PHPUnit)
...
- **674 tests** (Vitest + jsdom), 35 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
