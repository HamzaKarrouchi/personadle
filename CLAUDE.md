...
├── lang/                ← en.json (source de vérité, 1065 clés), fr/es/de/it/pt.json
...
├── tests/               ← 39 suites Vitest (801 tests) + tests/php/ (PHPUnit)
...
- **801 tests** (Vitest + jsdom), 39 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
