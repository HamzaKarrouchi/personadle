...
├── lang/                ← en.json (source de vérité, 1024 clés), fr/es/de/it/pt.json
...
├── tests/               ← 36 suites Vitest (687 tests) + tests/php/ (PHPUnit)
...
- **687 tests** (Vitest + jsdom), 36 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
