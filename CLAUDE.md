...
├── lang/                ← en.json (source de vérité, 1001 clés), fr/es/de/it/pt.json
...
├── tests/               ← 35 suites Vitest (670 tests) + tests/php/ (PHPUnit)
...
- **670 tests** (Vitest + jsdom), 35 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
