...
├── lang/                ← en.json (source de vérité, 1106 clés), fr/es/de/it/pt.json
...
├── tests/               ← 53 suites Vitest (943 tests) + tests/php/ (PHPUnit)
...
- **943 tests** (Vitest + jsdom), 53 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
