...
├── lang/                ← en.json (source de vérité, 1061 clés), fr/es/de/it/pt.json
...
├── tests/               ← 39 suites Vitest (794 tests) + tests/php/ (PHPUnit)
...
- **794 tests** (Vitest + jsdom), 39 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
