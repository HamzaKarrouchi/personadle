...
├── lang/                ← en.json (source de vérité, 985 clés), fr/es/de/it/pt.json
...
├── tests/               ← 32 suites Vitest (601 tests) + tests/php/ (PHPUnit)
...
- **601 tests** (Vitest + jsdom), 32 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
