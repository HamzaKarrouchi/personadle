...
├── lang/                ← en.json (source de vérité, 1062 clés), fr/es/de/it/pt.json
...
├── tests/               ← 39 suites Vitest (798 tests) + tests/php/ (PHPUnit)
...
- **798 tests** (Vitest + jsdom), 39 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
