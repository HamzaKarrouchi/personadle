...
├── lang/                ← en.json (source de vérité, 1110 clés), fr/es/de/it/pt.json
...
├── tests/               ← 54 suites Vitest (963 tests) + tests/php/ (PHPUnit)
...
- **963 tests** (Vitest + jsdom), 54 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
