...
├── lang/                ← en.json (source de vérité, 1067 clés), fr/es/de/it/pt.json
...
├── tests/               ← 39 suites Vitest (809 tests) + tests/php/ (PHPUnit)
...
- **809 tests** (Vitest + jsdom), 39 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
