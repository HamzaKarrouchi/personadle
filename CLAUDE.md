...
├── lang/                ← en.json (source de vérité, 967 clés), fr/es/de/it.json
...
├── tests/               ← 26 suites Vitest (481 tests) + tests/php/ (PHPUnit)
...
- **481 tests** (Vitest + jsdom), 26 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
