...
├── lang/                ← en.json (source de vérité, 990 clés), fr/es/de/it/pt.json
...
├── tests/               ← 35 suites Vitest (663 tests) + tests/php/ (PHPUnit)
...
- **663 tests** (Vitest + jsdom), 35 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
