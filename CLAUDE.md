...
├── lang/                ← en.json (source de vérité, 1071 clés), fr/es/de/it/pt.json
...
├── tests/               ← 41 suites Vitest (830 tests) + tests/php/ (PHPUnit)
...
- **830 tests** (Vitest + jsdom), 41 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
