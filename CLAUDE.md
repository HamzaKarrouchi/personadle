...
├── lang/                ← en.json (source de vérité, 1059 clés), fr/es/de/it/pt.json
...
├── tests/               ← 39 suites Vitest (789 tests) + tests/php/ (PHPUnit)
...
- **789 tests** (Vitest + jsdom), 39 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
