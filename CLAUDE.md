...
├── lang/                ← en.json (source de vérité, 1109 clés), fr/es/de/it/pt.json
...
├── tests/               ← 53 suites Vitest (951 tests) + tests/php/ (PHPUnit)
...
- **951 tests** (Vitest + jsdom), 53 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
