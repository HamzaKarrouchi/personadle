...
├── lang/                ← en.json (source de vérité, 1057 clés), fr/es/de/it/pt.json
...
├── tests/               ← 38 suites Vitest (781 tests) + tests/php/ (PHPUnit)
...
- **781 tests** (Vitest + jsdom), 38 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
