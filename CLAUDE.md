...
├── lang/                ← en.json (source de vérité, 1050 clés), fr/es/de/it/pt.json
...
├── tests/               ← 38 suites Vitest (778 tests) + tests/php/ (PHPUnit)
...
- **778 tests** (Vitest + jsdom), 38 suites dans `tests/` (`gameCore`, `backend`, `auth`, `i18n`,
