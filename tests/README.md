...
```
              ...
              ╱      ╲
             ╱────────╲   PHPUnit — 215 méthodes (13 fichiers, dont intégration vraie MariaDB)
...
> **215 méthodes de test** au total sur ces 13 fichiers. Les tests d'intégration tournent dans
