...
<img src="https://img.shields.io/badge/Vitest-866%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
              ...
              ╱      ╲
             ╱────────╲   PHPUnit — 239 méthodes (14 fichiers, dont intégration vraie MariaDB)
            ╱          ╲  contraintes SQL, FK cascade, contrat de schéma, streak/social/auth
           ╱────────────╲
          ╱              ╲ Vitest — 866 tests unitaires (jsdom, 46 fichiers)
...
| **Total**                        |**866**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |
...
> **239 méthodes de test** au total sur ces 14 fichiers. Les tests d'intégration tournent dans
