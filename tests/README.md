...
<img src="https://img.shields.io/badge/Vitest-983%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 983 tests unitaires (jsdom, 55 fichiers)
...
| **Total**                        |**983**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |
