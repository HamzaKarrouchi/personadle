...
<img src="https://img.shields.io/badge/Vitest-981%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
                 ╱╲
                ╱  ╲      Playwright E2E — 121 tests (stack Docker réelle)
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 981 tests unitaires (jsdom, 55 fichiers)
...
| **Total**                        |**981**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |
