...
```
              ...
              ╱      ╲
             ╱────────╲   PHPUnit — 158 méthodes (10 fichiers, dont intégration vraie MariaDB)
...
> **158 méthodes de test** au total sur ces 10 fichiers. Les tests d'intégration tournent dans
