...
<img src="https://img.shields.io/badge/Vitest-897%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 897 tests unitaires (jsdom, 51 fichiers)
...
| **Total**                        |**897**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |
