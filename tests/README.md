...
<img src="https://img.shields.io/badge/Vitest-499%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
              ...
              ╱      ╲
             ╱────────╲   PHPUnit — 179 méthodes (12 fichiers, dont intégration vraie MariaDB)
            ╱          ╲  contraintes SQL, FK cascade, contrat de schéma, streak/social/auth
           ╱────────────╲
          ╱              ╲ Vitest — 499 tests unitaires (jsdom, 27 fichiers)
...
> **179 méthodes de test** au total sur ces 12 fichiers. Les tests d'intégration tournent dans
