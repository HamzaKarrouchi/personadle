...
<img src="https://img.shields.io/badge/Vitest-943%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 943 tests unitaires (jsdom, 53 fichiers)
...
| **Total**                        |**943**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |
