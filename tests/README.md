...
```
              ...
              ╱      ╲
             ╱────────╲   PHPUnit — 165 méthodes (11 fichiers, dont intégration vraie MariaDB)
...
> **165 méthodes de test** au total sur ces 11 fichiers. Les tests d'intégration tournent dans
