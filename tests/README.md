...
<img src="https://img.shields.io/badge/Vitest-979%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
           ...
           ╱────────────╲
          ╱              ╲ Vitest — 979 tests unitaires (jsdom, 55 fichiers)
...
| **Total**                        |**979**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |
