...
<img src="https://img.shields.io/badge/Vitest-930%20passing-6E9F18?style=for-the-badge&logo=vitest&logoColor=white" alt="Vitest">
...
```
              ...
              ╱      ╲
             ╱────────╲   PHPUnit — 267 méthodes (15 fichiers, dont intégration vraie MariaDB)
            ╱          ╲  contraintes SQL, FK cascade, contrat de schéma, streak/social/auth
           ╱────────────╲
          ╱              ╲ Vitest — 930 tests unitaires (jsdom, 52 fichiers)
...
| **Total**                        |**930**| 45 suites — chiffres tenus à jour par `npm run docs:fix` |
...
> **267 méthodes de test** au total sur ces 15 fichiers. Les tests d'intégration tournent dans
