...
```
              ...
              ╱      ╲
             ╱────────╲   PHPUnit — 175 méthodes (12 fichiers, dont intégration vraie MariaDB)
...
> **175 méthodes de test** au total sur ces 12 fichiers. Les tests d'intégration tournent dans
