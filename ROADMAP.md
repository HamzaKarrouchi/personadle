...
> **482 tests JS · 175 PHPUnit · 54 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 482 Vitest · 175 PHPUnit · 54 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |
| Q2  | i18n EN/FR/ES/DE/IT (969 clés)                | `npm run i18n:check`                                                          |
