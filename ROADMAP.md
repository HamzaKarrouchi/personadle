...
> **951 tests JS · 269 PHPUnit · 113 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 951 Vitest · 269 PHPUnit · 113 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |
| Q2  | i18n EN/FR/ES/DE/IT/PT (1109 clés)             | `npm run i18n:check`                                                          |
