...
> **794 tests JS · 193 PHPUnit · 102 E2E · PHPStan niveau 5 · CI/CD GitHub Actions**.
...
| #   | Élément                                       | Notes                                                                         |
| --- | --------------------------------------------- | ----------------------------------------------------------------------------- |
| Q1  | Tests : 794 Vitest · 193 PHPUnit · 102 E2E     | `npm test` · `make test-php` · `npm run test:e2e`                             |
| Q2  | i18n EN/FR/ES/DE/IT/PT (1061 clés)             | `npm run i18n:check`                                                          |
