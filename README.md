...
- 24-table relational schema, 930+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 930 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 930 tests automatisés (Vitest + PHPUnit + Playwright).
