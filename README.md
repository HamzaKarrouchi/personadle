...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-801%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 23-table relational schema, 801+ unit tests (Vitest + jsdom)
...
- 6 languages: EN · FR · ES · DE · IT · PT (1065 keys each)
...
```
Vitest + jsdom → 801 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
PHPUnit        → tests de logique pure + intégration DB (contrat de schéma)
Playwright     → 109 E2E sur la stack Docker complète (smoke, API, Social Link)
...
quotidiens, i18n 6 langues, panel admin, 801 tests automatisés (Vitest + PHPUnit + Playwright).
