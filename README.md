...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-465%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 23-table relational schema, 465+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 465 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 5 langues, panel admin, 465 tests automatisés (Vitest + PHPUnit + Playwright).
