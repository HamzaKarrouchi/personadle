...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-963%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 24-table relational schema, 963+ unit tests (Vitest + jsdom)
...
- 6 languages: EN · FR · ES · DE · IT · PT (1110 keys each)
...
```
Vitest + jsdom → 963 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 963 tests automatisés (Vitest + PHPUnit + Playwright).
