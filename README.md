...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-615%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 23-table relational schema, 615+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 615 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 615 tests automatisés (Vitest + PHPUnit + Playwright).
