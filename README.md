...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-699%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 23-table relational schema, 699+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 699 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 699 tests automatisés (Vitest + PHPUnit + Playwright).
