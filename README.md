...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-975%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 24-table relational schema, 975+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 975 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 975 tests automatisés (Vitest + PHPUnit + Playwright).
