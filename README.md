...
- 23-table relational schema, 481+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 481 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 5 langues, panel admin, 481 tests automatisés (Vitest + PHPUnit + Playwright).
