...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-842%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 24-table relational schema, 842+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 842 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 842 tests automatisés (Vitest + PHPUnit + Playwright).
