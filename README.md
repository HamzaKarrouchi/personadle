...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-674%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 23-table relational schema, 674+ unit tests (Vitest + jsdom)
...
- 6 languages: EN · FR · ES · DE · IT · PT (1004 keys each)
...
```
Vitest + jsdom → 674 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 674 tests automatisés (Vitest + PHPUnit + Playwright).
