...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-830%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 24-table relational schema, 830+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 830 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 830 tests automatisés (Vitest + PHPUnit + Playwright).
