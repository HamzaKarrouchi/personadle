...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-482%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 23-table relational schema, 482+ unit tests (Vitest + jsdom)
...
- 5 languages: EN · FR · ES · DE · IT (968 keys each)
...
```
Vitest + jsdom → 482 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 5 langues, panel admin, 482 tests automatisés (Vitest + PHPUnit + Playwright).
