...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-983%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 24-table relational schema, 983+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 983 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
PHPUnit        → tests de logique pure + intégration DB (contrat de schéma)
Playwright     → 133 E2E sur la stack Docker complète (smoke, API, Social Link)
...
quotidiens, i18n 6 langues, panel admin, 983 tests automatisés (Vitest + PHPUnit + Playwright).
