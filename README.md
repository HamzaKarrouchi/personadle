...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-604%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 23-table relational schema, 604+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 604 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 604 tests automatisés (Vitest + PHPUnit + Playwright).
