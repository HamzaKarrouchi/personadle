...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-984%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 24-table relational schema, 984+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 984 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 984 tests automatisés (Vitest + PHPUnit + Playwright).
