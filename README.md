...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-868%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 24-table relational schema, 868+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 868 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 868 tests automatisés (Vitest + PHPUnit + Playwright).
