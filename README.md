...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-798%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 23-table relational schema, 798+ unit tests (Vitest + jsdom)
...
- 6 languages: EN · FR · ES · DE · IT · PT (1062 keys each)
...
```
Vitest + jsdom → 798 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 798 tests automatisés (Vitest + PHPUnit + Playwright).
