...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-981%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 24-table relational schema, 981+ unit tests (Vitest + jsdom)
...
- 6 languages: EN · FR · ES · DE · IT · PT (1115 keys each)
...
```
Vitest + jsdom → 981 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
PHPUnit        → tests de logique pure + intégration DB (contrat de schéma)
Playwright     → 118 E2E sur la stack Docker complète (smoke, API, Social Link)
...
quotidiens, i18n 6 langues, panel admin, 981 tests automatisés (Vitest + PHPUnit + Playwright).
