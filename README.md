...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-473%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 23-table relational schema, 473+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 473 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
PHPUnit        → tests de logique pure + intégration DB (contrat de schéma)
Playwright     → 20 E2E sur la stack Docker complète (smoke, API, Social Link)
...
quotidiens, i18n 5 langues, panel admin, 473 tests automatisés (Vitest + PHPUnit + Playwright).
