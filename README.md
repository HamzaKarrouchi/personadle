...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-789%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 23-table relational schema, 789+ unit tests (Vitest + jsdom)
...
- 6 languages: EN · FR · ES · DE · IT · PT (1059 keys each)
...
```
Vitest + jsdom → 789 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 789 tests automatisés (Vitest + PHPUnit + Playwright).
