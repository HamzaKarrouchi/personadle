...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-935%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 24-table relational schema, 935+ unit tests (Vitest + jsdom)
...
- 6 languages: EN · FR · ES · DE · IT · PT (1103 keys each)
...
```
Vitest + jsdom → 935 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 935 tests automatisés (Vitest + PHPUnit + Playwright).
