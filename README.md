...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-670%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 23-table relational schema, 670+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 670 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 670 tests automatisés (Vitest + PHPUnit + Playwright).
