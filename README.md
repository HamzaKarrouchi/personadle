...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-979%20passing-brightgreen?style=for-the-badge&logo=vitest" alt="Tests">
...
- 24-table relational schema, 979+ unit tests (Vitest + jsdom)
...
```
Vitest + jsdom → 979 tests unitaires (logique de jeu, backend, streak, i18n, validation données)
...
quotidiens, i18n 6 langues, panel admin, 979 tests automatisés (Vitest + PHPUnit + Playwright).
