...
## 24 — Code événement pointant vers un badge inexistant (retour Léo, 19 juillet 2026) — à re-tester
...
### 24.1 Création d'un code avec un badge_id invalide → refusée
...
### 24.2 Création d'un code avec un badge_id valide → toujours fonctionnel
